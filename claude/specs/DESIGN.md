...
colors:
  primary: "#7B61FF"         # Signal Violet — cor de marca Novidda
  on-primary: "#F5F5F0"      # Off-white sobre violet
  primary-active: "#9D8FFF"  # Violet claro / hover / foco
  primary-neutral: "#C4BAFF" # Violet neutro / borda sutil
  primary-pale: "#E8E4FF"    # Violet pálido / fundo de tag/badge
  ink: "#16213E"             # Eigengrau — near-black exclusivo da marca
  ink-deep: "#0A0F1E"        # Eigengrau profundo / dark mode bg
  body: "#3D3D5C"            # Texto corpo (tom azul-escuro)
  mute: "#8B8BA0"            # Placeholder / texto secundário
  canvas: "#F5F5F0"          # Fundo principal (off-white quente)
  canvas-soft: "#E0DCFF"     # Fundo neumórfico / surface de cards
  positive: "#2EB87A"        # Sucesso / publicado
  positive-deep: "#0A6647"   # Verde profundo
  warning: "#FFB347"         # Amber / rascunho / atenção
  warning-deep: "#9C6200"    # Amber profundo
  warning-content: "#3D2E00" # Texto sobre fundo amber
  negative: "#D03060"        # Erro / rejeitar comentário
  negative-deep: "#A01040"   # Vermelho profundo
  negative-darkest: "#7A0030"
  negative-bg: "#2D0A1A"     # Fundo dark de erro
  accent-orange: "#E8613A"   # Terracota / energia LatAm (Fase 2)
  accent-cyan: "#38B8E0"     # Cyan / info / gráficos de analytics
